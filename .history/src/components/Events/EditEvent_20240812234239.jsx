...
export default function EditEvent() {
  ...
  const { mutate } = useMutation({
    ...
    onMutate: async (data) => {
      ...
      queryClient.setQueryData({ queryKey: ["events", id] }, newEvent);
    },
    //onMutate is executed when the mutation is triggered, which in this case is when the handleSubmit function is called.
  });
