...
export default function EventDetails() {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: () => {
      //immediately invalid query and re-fetch data, which means the current component will fetch the data before it's un-mounted
      queryClient.invalidateQueries({
        queryKey: ["events"],
        refetchType: "none",
        //In the current component (EventDetails), the data will not be refetched immediately.
